...
.danger-type-input{width:100%;padding:8px 12px;border-radius:6px;border:none;background:rgba(0,0,0,0.25);color:#ef4444;font-size:14px;font-weight:600;letter-spacing:2px;outline:none;margin-bottom:12px;box-sizing:border-box}
...
@media (max-width:768px){.theme-buttons{gap:6px}.theme-btn{padding:10px;font-size:14px}.theme-btn svg{width:18px;height:18px}.settings-modal{padding:0}.settings-body{padding:58px 16px 20px 16px}.settings-section{margin-bottom:28px;padding-bottom:20px}.settings-section h4{font-size:16px}.setting-toggle{padding:14px}.settings-saved-indicator{bottom:16px;left:16px;right:16px;transform:none;width:calc(100% - 32px);justify-content:center}.gps-active-placeholder{gap:10px;padding:20px 10px}}
...
.warning-title{font-weight:700;font-size:16px;margin-bottom:6px}
.warning-message{font-size:12px;line-height:1.5;opacity:0.95}
.warning-actions{display:flex;gap:10px;flex-shrink:0}
.warning-btn{padding:10px 20px;border-radius:25px;font-size:14px;font-weight:600;border:none;cursor:pointer;transition:all 0.2s;white-space:nowrap;display:flex;align-items:center;gap:6px;backdrop-filter:blur(1px) saturate(180%);-webkit-backdrop-filter:blur(1px) saturate(180%)}
...
.session-limit-modal h3{margin:0;font-size:20px;font-weight:600}
.session-limit-modal .modal-body{padding:0 24px}
.limit-explanation{font-size:15px;margin-bottom:16px}
.limit-reason{font-size:14px;font-weight:500;margin-bottom:8px}
.limit-reasons{list-style:none;padding:0;margin:0 0 16px 0}
.limit-reasons li{padding:8px 12px 8px 36px;position:relative;font-size:14px;border-left:3px solid;margin-bottom:6px;border-radius:4px}
.limit-reasons li::before{content:"•";position:absolute;left:16px;font-weight:bold}
.limit-suggestion{font-size:14px;font-style:italic}
.session-limit-modal .modal-actions{padding:12px 24px;display:flex;flex-direction:column;gap:12px}
.btn-primary.large{padding:14px 24px;font-size:15px;font-weight:600;border-radius:25px;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:all 0.2s;backdrop-filter:blur(1px) saturate(180%);-webkit-backdrop-filter:blur(1px) saturate(180%)}
.btn-secondary{padding:12px 24px;font-size:14px;border-radius:25px;background:transparent;cursor:pointer;transition:all 0.2s}
...
.new-chat-btn{background:transparent;color:inherit;border:none;height:38px;padding:0 15px;border-radius:25px;cursor:pointer;display:flex;align-items:center;gap:6px;font-weight:500;transition:all 0.3s ease;backdrop-filter:blur(1px) saturate(160%);-webkit-backdrop-filter:blur(1px) saturate(160%)}
...
/* Seam depth — the photo casts a soft shadow onto the top of the info panel, so
   image + details read as one solid object instead of two stacked blocks. Sits
   over the panel's top padding only (pointer-events:none), so it never touches
   the text; theme-aware so it deepens the night glass and warms the day glass. */
.rec-details{position:relative}
.rec-details::before{content:'';position:absolute;top:0;left:0;right:0;height:12px;pointer-events:none;z-index:2}
.genie-chat-container.night-mode .rec-details::before{background:linear-gradient(to bottom,rgba(0,0,0,0.32),rgba(0,0,0,0))}
.genie-chat-container.day-mode .rec-details::before{background:linear-gradient(to bottom,rgba(60,35,10,0.13),rgba(60,35,10,0))}
/* Photo melt — the picture dissolves into the panel at its lower edge instead of
   a hard cut, so image + details flow as one. z-index:1 keeps it BELOW the hover
   overlay (More/Ask) and the save ribbon; pointer-events:none so taps pass through.
   Theme-aware: sinks into the dark night glass, lifts into the light day glass. */
.rec-image::after{content:'';position:absolute;left:0;right:0;bottom:0;height:56px;pointer-events:none;z-index:1}
.genie-chat-container.night-mode .rec-image::after{background:linear-gradient(to bottom,rgba(26,18,48,0) 0%,rgba(26,18,48,0.55) 100%)}
.genie-chat-container.day-mode .rec-image::after{background:linear-gradient(to bottom,rgba(255,255,255,0) 0%,rgba(255,255,255,0.42) 100%)}
...
.greeting-icon{width:60px;height:60px;object-fit:contain}
.greeting{font-size:1.5rem;font-weight:150;margin:0}
...
.input-wrapper textarea{flex:1;background:transparent;border:none;padding:15px 52px 15px 15px;font-size:1rem;resize:none;overflow-y:auto;min-height:50px;max-height:200px}
...
.pref-chip{padding:4.5px 11px;border-radius:999px;font-size:12px;font-weight:600;background:rgba(120,120,120,0.15);color:#4a4a4a}
...
.plan-label{font-size:13px;font-weight:600;opacity:0.75}
.plan-badge{display:inline-flex;align-items:center;gap:5px;padding:4px 11px;border-radius:999px;font-size:12px;font-weight:700;letter-spacing:0.02em}
...
.popover-actions-list{display:flex;flex-direction:column;max-height:310px;overflow-y:auto}
...
.genie-chat-container.night-mode .view-more-btn:hover:not(:disabled),.genie-chat-container.night-mode .image-request-btn:hover:not(:disabled){background:rgba(255,255,255,0.14);box-shadow:inset 0 0 0 1.5px rgba(255,255,255,0.1)}
...
.genie-chat-container.night-mode .card-glow--verified .image-request-btn{color:#22c5567c;background:rgba(34,197,94,0.1);box-shadow:inset 0 0 0 1.5px rgba(34,197,94,0.09)}
.genie-chat-container.night-mode .card-glow--verified .image-request-btn:hover{background:rgba(34,197,94,0.2)!important;box-shadow:inset 0 0 0 1.5px rgba(34,197,94,0.1)!important}
...
.genie-chat-container.night-mode .card-glow--spotlight .image-request-btn{color:#3b9fdda2;background:rgba(59,158,221,0.1);box-shadow:inset 0 0 0 1.5px rgba(59,158,221,0.09)}
.genie-chat-container.night-mode .card-glow--spotlight .image-request-btn:hover{background:rgba(59,158,221,0.2)!important;box-shadow:inset 0 0 0 1.5px rgba(59,158,221,0.1)!important}
...
.genie-chat-container.night-mode .card-glow--signature .image-request-btn{color:#ffbf0085;background:rgba(212,175,55,0.1);box-shadow:inset 0 0 0 1.5px rgba(212,175,55,0.09)}
.genie-chat-container.night-mode .card-glow--signature .image-request-btn:hover{background:rgba(212,175,55,0.2)!important;box-shadow:inset 0 0 0 1.5px rgba(212,175,55,0.1)!important}
...
.saved-panel.night .card-glow--verified .image-request-btn{color:#22c5567c;background:rgba(34,197,94,0.1);box-shadow:inset 0 0 0 1.5px rgba(34,197,94,0.09)}
.saved-panel.night .card-glow--verified .image-request-btn:hover{background:rgba(34,197,94,0.2)!important;box-shadow:inset 0 0 0 1.5px rgba(34,197,94,0.1)!important}
...
.saved-panel.night .card-glow--spotlight .image-request-btn{color:#3b9fdda2;background:rgba(59,158,221,0.1);box-shadow:inset 0 0 0 1.5px rgba(59,158,221,0.09)}
.saved-panel.night .card-glow--spotlight .image-request-btn:hover{background:rgba(59,158,221,0.2)!important;box-shadow:inset 0 0 0 1.5px rgba(59,158,221,0.1)!important}
...
.saved-panel.night .card-glow--signature .image-request-btn{color:#ffbf0085;background:rgba(212,175,55,0.1);box-shadow:inset 0 0 0 1.5px rgba(212,175,55,0.09)}
.saved-panel.night .card-glow--signature .image-request-btn:hover{background:rgba(212,175,55,0.2)!important;box-shadow:inset 0 0 0 1.5px rgba(212,175,55,0.1)!important}
