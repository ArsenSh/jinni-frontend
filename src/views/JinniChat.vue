      ...
      <div v-if="sidebarOpen || mobileSidebarOpen || (!sidebarOpen && isDesktop)" class="sidebar-footer">
        ...
        <transition name="profile-menu">
          <div v-if="showProfileMenu" class="profile-menu" :class="{ 'profile-menu-collapsed': !sidebarOpen }" v-click-outside="closeProfileMenu" @click.stop>
            ...
            <button @click="goToShotSpots" class="profile-menu-item">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/>
                <circle cx="12" cy="13" r="4"/>
              </svg>
              <span v-if="sidebarOpen">{{ t('chat.profile.shot_spots') || "Shot Spots" }}</span>
            </button>
...
.selector-dropdown-inline{width:100%;border-radius:8px;overflow:hidden;margin-top:8px;max-height:350px;display:flex;flex-direction:column;border:1px solid}
...
.dropdown-list{overflow-y:auto;max-height:350px;-webkit-overflow-scrolling:touch;scrollbar-width:none;-ms-overflow-style:none}
