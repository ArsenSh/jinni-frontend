...
<style scoped>
/* Base */
.contact-page{min-height:100vh;transition:background 0.5s ease,color 0.3s ease;font-family: var(--app-font, 'Segoe UI', Tahoma, Geneva, Verdana, 'Noto Sans Armenian', sans-serif);display:flex;flex-direction:column;position:relative;z-index:1}
/* Header */
...
.contact-page.day-mode{background:linear-gradient(180deg,#f9f5eb 0%,#e0a082 30%,#e0a082 78%,#f9f5eb 100%)}
</style>